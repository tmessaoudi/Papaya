...
export class MenuItemSlider {
  ...
  buildHTML(parentId) {
    ...
    html = "<li id='" + this.id + "'><span style='padding-right:5px;' class='" + constant.PAPAYA_MENU_UNSELECTABLE + "'>" +
      this.label + ":</span><input min='0' max='100' value='" + parseInt((1.0 - this.screenVol[this.action]) * 100,
        10) + "' id='" + sliderId + "' class='" + constant.PAPAYA_MENU_SLIDER + "' type='range' /></li>"
