...
import { papayaRoundFast } from "../utilities"

export class VoxelValue {
  /*** Constructor ***/
  constructor(imageData, imageType, imageDimensions, imageRange,
    orientation) {
  ...
  getVoxelAtOffset(volOffset, timepoint, xLoc, yLoc, zLoc) {
    var dataScaleIndex,
  ...
  getVoxelAtIndexLinear(xLoc, yLoc, zLoc, timepoint) {
