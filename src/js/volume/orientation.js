...
import { papayaFloorFast, papayaRoundFast } from "../utilities"
...
export class Orientation {
  ...
  static isValidOrientationString(orientationStr) {
    var temp, valid = true
  ...
  convertIndexToOffsetNative(xLoc, yLoc, zLoc) {
  ...
  convertCoordinate(coord, coordConverted) {
  ...
  createInfo(imageDimensions, voxelDimensions) {
  ...
  isValid() {
    return Orientation.isValidOrientationString(this.orientation)
  };
