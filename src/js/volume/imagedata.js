...
export class ImageData {
  ...
  readFileData(header, buffer, onReadFinish) {
    ...
    // create typed array
    if (header.imageType.datatype === ImageType.DATATYPE_RGB) {
      /*jslint bitwise: true */
    ...
    } else if ((header.imageType.datatype === ImageType.DATATYPE_INTEGER_SIGNED) &&
      (header.imageType.numBytes === 1)) {
      this.data = new Int8Array(buffer, 0, buffer.byteLength)
    } else if ((header.imageType.datatype === ImageType.DATATYPE_INTEGER_UNSIGNED) &&
      (header.imageType.numBytes === 1)) {
    ...
    } else if ((header.imageType.datatype === ImageType.DATATYPE_FLOAT) && (header.imageType.numBytes === 4)) {
    ...
    } else if ((header.imageType.datatype === ImageType.DATATYPE_FLOAT) && (header.imageType.numBytes === 8)) {
      if (header.imageType.swapped) {
